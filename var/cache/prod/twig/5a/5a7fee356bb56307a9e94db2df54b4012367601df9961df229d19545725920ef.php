...
class __TwigTemplate_2af63b4d7551b651a6615815548d4c16eac8bc89ab7acbe96669ef00cbc3ca29 extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    <title>Welcome to Sextan API V2!</title>
    <style>
                                body { background: hsla(284, 20%, 95%, 1); color: hsla(284, 20%, 45%, 1); display: flex; font: 16px/1.5 sans-serif; justify-content: center; margin: 0; }
        h1, h2 { line-height: 1.2; margin: 0 0 .5em; }
        h1 { font-size: 36px; }
        h2 { font-size: 21px; margin-bottom: 1em; }
        a { color: hsla(284, 20%, 45%, 0.75) }
        a:hover { text-decoration: none; }
        code { border-radius: 25px; background: hsla(284, 20%, 95%, 1); box-shadow: 0 0 45px -15px hsl(284, 20%, 2%); color: hsla(284, 20%, 45%, 1); font-family: SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace; align-items: center; padding-right: 20px; position: relative; word-wrap: break-word; z-index: 1; }
        svg { overflow: hidden; vertical-align: text-bottom; }
        .wrapper { text-align: center; width: 100%; }
        .container { position: relative; background: radial-gradient(ellipse at bottom, hsla(284, 20%, 45%, 1) 0%, hsl(284, 20%, 13%) 100%); background-attachment: fixed; color: hsla(284, 20%, 95%, 1); }
        ...
        .warning { background: hsla(284, 20%, 95%, 1); display: flex; align-content: center; padding: 10px; text-align: left; justify-content: center; }
        ...
        .container .logo svg { fill: hsl(284, 20%, 26%); }
        ...
        .check { background: hsla(284, 20%, 45%, 1); border-radius: 20px; width: 50px; display: flex; align-items: center; justify-content: center; height: 37px; margin: 6px 8px 6px 6px; }
        .check svg { fill: hsla(284, 20%, 95%, 1); }
        ...
        .resource svg { height: 48px; width: 48px; fill: hsla(284, 20%, 45%, 1); margin-bottom: 5px; }
...
<div class=\"wrapper\">
    ...
    <div class=\"container\">
        <div class=\"welcome\">
            <div class=\"logo\">
                <img src=\"https://image.flaticon.com/icons/svg/966/966443.svg\" width=\"120\">
            </div>
            <h1><small>Welcome to</small> Sextan API <span class=\"version\">2.0</span></h1>
        </div>
...
";
    ...
    {
        return array (  130 => 114,  37 => 2,);
    }

    public function getSourceContext()
    {
        return new Source("", "home/index.html.twig", "/var/www/html/sextan_api_v2/templates/home/index.html.twig");
    }
}
